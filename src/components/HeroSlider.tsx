  ...
  return (
    <section id="hero" className="relative h-screen w-full bg-black overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        <h2 className="font-sans text-base sm:text-lg md:text-xl font-medium tracking-[0.15em] text-white mb-2 leading-tight uppercase">
          {activeTitle}
        </h2>
        ...
        {activeSignature && (
          <span className="font-sans italic text-[9px] text-neutral-500 mt-3 block">
            {activeSignature}
          </span>
        )}
      </motion.div>
